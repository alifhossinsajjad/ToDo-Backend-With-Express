...
function findFuzzyTodo(todos, targetTitle) {
...
todosRouter.get("/", catchAsync(async (req, res) => {
...
todosRouter.post("/create-todo", validateRequest(TodoValidation.createTodoZodSchema), catchAsync(async (req, res) => {
...
todosRouter.get("/:id", catchAsync(async (req, res) => {
...
todosRouter.patch("/update-todo/:id", validateRequest(TodoValidation.updateTodoZodSchema), catchAsync(async (req, res) => {
    const id = req.params.id;
...
todosRouter.delete("/delete-todo/:id", catchAsync(async (req, res) => {
    const id = req.params.id;
    if (!ObjectId.isValid(id)) {
        throw new ApiError(400, "Invalid ID format!");
    }
